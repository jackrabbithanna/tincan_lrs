...
/**
 * The class used for tincan_activity_profile entities
 */
...
/**
 * The Controller for TincanActivityProfile entities
 */
class TincanActivityProfileController extends EntityAPIController {
  public function __construct($entityType) {
   ...
   /* @return
   *   A tincan_activity_profile object with all default fields initialized.
   */
  ...
  public function entityPropertyInfo() {
    $info = parent::entityPropertyInfo();
      ...
      $info[$this->type]['properties']['json'] = array(
        'label' => t("Activity Profile JSON"), 
        'type' => 'text', 
        'description' => t("The JSON representation of the activity profile"),
        'schema field' => 'json',
        'getter callback' => 'entity_property_verbatim_get',
        'setter callback' => 'entity_property_verbatim_set',
      );
